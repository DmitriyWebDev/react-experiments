...
const restoreScrollPosition = (WrappedComponent) => {
    return class RestoreScrollPosition extends React.Component {
        constructor(props) {
            ...
            this.setComponentNameForScrollRestore = this.setComponentNameForScrollRestore.bind(this);
            this.state = {
        ...
        canRestoreScrollPosition() {
            ...
            const scrollData = sessionStorage.getItem(`${storageKeyPrefix}_${componentName}`)
        ...
        render() {
            return(
                <WrappedComponent
                    {...this.props} setComponentNameForScrollRestore={this.setComponentNameForScrollRestore}
                />
            )
        }
    }
