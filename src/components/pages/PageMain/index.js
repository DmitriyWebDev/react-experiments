    ...
    render() {
        return(
            <div className={'page_animated'}>
                ...
                <div style={{width: '300px', border: '1px solid black', background: 'blue'}}>
                    <TextShower text={'Hello, World!!! Hello, World!!! Hello, World!!!'}/>
                </div>
                ...
                <div style={{width: '300px', border: '1px solid black', background: 'blue', padding: '10px'}}>
                    <TextListShower textLinesList={[
                ...
                <div style={{width: '100px', border: '1px solid black', background: 'blue', padding: '10px'}}>
                    <TextListShower textLinesList={[
                        '1. Hello, World!!! Hello, World!!! Hello, World!!!', //
                        '2. Hello, World!!!',
                        '3. Hello, World!!! Hello, World!!! Hello, World!!!'
