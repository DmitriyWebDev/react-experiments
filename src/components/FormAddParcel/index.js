...
class FormAddParcel extends React.Component {
    constructor(props) {
        ...
        this.handleChangeParcelAttributes = this.handleChangeParcelAttributes.bind(this);
                ...
                <div className={parcelAttributesClass}>
                    ...
                    <label>
                        <input
                            type="checkbox"
                            value="хрупкая"
                            checked={typeof this.state.parcelAttributes.value['хрупкая'] !== 'undefined'}
                    ...
                    <label>
                        <input
                            type="checkbox"
                            value="тяжёлая"
                            checked={typeof this.state.parcelAttributes.value['тяжёлая'] !== 'undefined'}
                            onChange={this.handleChangeParcelAttributes}
                        />
                        тяжёлая
                    </label>
                    <label>
                        <input
                            ...
                            checked={typeof this.state.parcelAttributes.value['крупногабаритная'] !== 'undefined'}
                            onChange={this.handleChangeParcelAttributes}
                        />
                        крупногабаритная
                    </label>
                    <label>
                        <input
                            type="checkbox"
                            value="новогодняя"
                            checked={typeof this.state.parcelAttributes.value['новогодняя'] !== 'undefined'}
                            onChange={this.handleChangeParcelAttributes}
                        />
                        новогодняя
                    </label>
